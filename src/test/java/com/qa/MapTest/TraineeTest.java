...
public class TraineeTest {
	...
	public void getClassroom() {
		assertEquals(
				"{\"classroomID\":0,\"trainer\":\"Matt Hunt\",\"trainees\":[{\"traineeID\":1,\"traineeName\":\"Joe Bloggs\"},{\"traineeID\":2,\"traineeName\":\"Jane Bloggs\"}]}",
	...
	public void updateClassroom() {
		...
		assertEquals(
				"{\"classroomID\":1,\"trainer\":\"Chester Gardner\",\"trainees\":[{\"traineeID\":1,\"traineeName\":\"Joe Bloggs\"},{\"traineeID\":2,\"traineeName\":\"Jane Bloggs\"}]}",
				classroomRepo.getClassroom(0));
	}
	...
	public void newTrainees() {
		...
		classroomRepo.updateClassroom(0, new JSONUtil().getJSONForObject(class2));
		assertEquals(
				"{\"classroomID\":1,\"trainer\":\"Chester Gardner\",\"trainees\":[{\"traineeID\":1,\"traineeName\":\"David Bloggs\"},{\"traineeID\":2,\"traineeName\":\"Ceri Bloggs\"}]}",
				classroomRepo.getClassroom(0));
	}
